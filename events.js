...
myEmitter.addListener("example", () =>
  console.log(`my first 'example' bound emitter function`)
);
myEmitter.on("example", () =>
  console.log(`my second 'example' bound emitter function`)
);
myEmitter.on("example", () =>
...
myEmitter.on("sample", () =>
  console.log(`my third 'sample' bound emitter function`)
);
myEmitter.on("sample", () =>
  console.log(`my fourth 'sample' bound emitter function`)
);
